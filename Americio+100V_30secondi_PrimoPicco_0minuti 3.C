{
    ...
    TH1D *h1 = new TH1D("Histogram and Fit parameters","Americio+100V_30secondi_PrimoPicco_0minuti",1024,0,1023);
    // TH1D *h2 = new TH1D("Histogram parameters","Spettro Cobalto (scintillatore A);# CH;Counts",1024,0,1023);
    
    in.open("Americio+100V_30secondi_PrimoPicco_0minuti.mca");
    ...
    TCanvas *c1 = new TCanvas("c1","Americio+100V_30secondi_PrimoPicco_0minuti", 1600, 1200);
    
    h1->SetMinimum(0);
    Double_t par[4];
    TF1 *g0    = new TF1("g0","gaus",783,811);
    ...
    h1->Fit(total,"R");
    c1->SaveAs("Americio+100V_30secondi_PrimoPicco_0minuticonFit.pdf",".pdf");
    c1->SaveAs("Americio+100V_30secondi_PrimoPicco_0minuticonFit.root",".root");
}
