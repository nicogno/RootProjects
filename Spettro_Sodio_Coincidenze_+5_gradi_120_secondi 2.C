{
    ...
    TCanvas *c1 = new TCanvas("c1","Spettro_Sodio_Coincidenze_+5_gradi_120_secondi", 1600, 1200);
    TH1D *h1 = new TH1D("Histogram and Fit parameters","Coincidenze Sodio (+5 gradi, 120 secondi);# CH;Counts",1024,0,1023);
    
    in.open("Spettro_Sodio_Coincidenze_+5_gradi_120_secondi.mca");
    ...
    TF1 *g0    = new TF1("g0","gaus",620,680);
    TF1 *g1    = new TF1("g1","gaus",680,720);
    ...
    h1->Fit(total,"R");
    c1->SaveAs("Spettro_Sodio_Coincidenze_+5_gradi_120_secondi.pdf",".pdf");
    c1->SaveAs("Spettro_Sodio_Coincidenze_+5_gradi_120_secondi.root",".root");
}
