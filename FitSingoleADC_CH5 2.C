{
    ...
    double xmax, xmin;
    TCanvas *c1 = new TCanvas("c1","ADC CH5", 1600, 1600);
    
    in.open("ADCsingoleCH5.dat");

    TH1D *h1 = new TH1D("Gauss fit parameters","Background;ADC Channels;Counts",1000,0,400);
