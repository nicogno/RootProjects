{
    ...
    TCanvas *c1 = new TCanvas("c1","Spettro_Sodio_Coincidenze_+10_gradi_60_secondi", 1600, 1200);
    TH1D *h1 = new TH1D("Histogram and Fit parameters","Coincidenze Sodio (+10 gradi, 60 secondi);# CH;Counts",1024,0,1023);
    
    in.open("Spettro_Sodio_Coincidenze_+10_gradi_60_secondi.mca");
    ...
    h1->Fit(total,"R");
    c1->SaveAs("Spettro_Sodio_Coincidenze_+10_gradi_60_secondi.pdf",".pdf");
    c1->SaveAs("Spettro_Sodio_Coincidenze_+10_gradi_60_secondi.root",".root");
}
