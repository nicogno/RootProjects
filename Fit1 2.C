{
    ...
    for(int fileIndex = 0; fileIndex<FileNames.size(); fileIndex++) {
        ...
        const char * HistTitle = FileNames[fileIndex].substr(0, FileNames[fileIndex].size()-4).c_str();
        
        in.open(HistName);
        x = 0, y = 0, z = 0, nlines = 0;
        
        histoArray[fileIndex] = new TH1D("Histogram and Fit parameters",HistTitle,1000,0,1000);
