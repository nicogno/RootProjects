{
    ...
    TCanvas *c1 = new TCanvas("c1","Spettro_Sodio_Coincidenze_-10_gradi_120_secondi", 1600, 1200);
    TH1D *h1 = new TH1D("Histogram and Fit parameters","Coincidenze Sodio (-10 gradi, 120 secondi);# CH;Counts",1024,0,1023);
    
    in.open("Spettro_Sodio_Coincidenze_-10_gradi_120_secondi.mca");
    ...
    h1->Fit(total,"R");
    c1->SaveAs("Spettro_Sodio_Coincidenze_-10_gradi_120_secondi.pdf",".pdf");
    c1->SaveAs("Spettro_Sodio_Coincidenze_-10_gradi_120_secondi.root",".root");
}
