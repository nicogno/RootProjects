{
    ...
    TH1D *h1 = new TH1D("Histogram and Fit parameters","Spettro Cobalto (scintillatore A);# CH;Counts",1024,0,1023);
    TH1D *h2 = new TH1D("Histogram parameters","Spettro Cobalto (scintillatore A);# CH;Counts",1024,0,1023);
    
    in.open("Spettro_Cobalto_Acciaio.mca");
    ...
    TCanvas *c1 = new TCanvas("c1","Spettro_Cobalto_Acciaio", 1600, 1200);
    
    h1->SetMinimum(0);
    Double_t par[6];
    TF1 *g0    = new TF1("g1","gaus",740,840);
    ...
    h1->Fit(total,"R");
    c1->SaveAs("Spettro_Cobalto_Acciaio_Con_Fit.pdf",".pdf");
    c1->SaveAs("Spettro_Cobalto_Acciaio.root",".root");
}
