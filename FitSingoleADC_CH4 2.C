{
    ...
    double xmax, xmin;
    TCanvas *c1 = new TCanvas("c1","ADC CH4", 1600, 1600);
    
    in.open("ADCsingoleCH4.dat");

    TH1D *h1 = new TH1D("Gauss fit parameters","Background;ADC Channels;Counts",1000,0,150);
    TH1D *h2 = new TH1D("Landau fit parameters","Signal;ADC Channels;Counts",1000,0,800);
    ...
    h3->DrawCopy("","");
    c1->cd(4);          //////////////////////
    TH1 *frame = c1->DrawFrame(0,0,800,6000,"Pedestal + Signal;ADC Channels;Counts");
    c1->Update();
    h3->Draw("SAME");
    h2->Draw("SAME");
    c1->SaveAs("ADC CH4.pdf","pdf");
}
