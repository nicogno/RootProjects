{
    ...
    TH1D *h1 = new TH1D("Histogram and Fit parameters","Americio-100V",1024,0,1023);
    // TH1D *h2 = new TH1D("Histogram parameters","Spettro Cobalto (scintillatore A);# CH;Counts",1024,0,1023);
    
    in.open("Americio-100V.mca");
    ...
    TCanvas *c1 = new TCanvas("c1","Americio-100V", 1600, 1200);
    
    h1->SetMinimum(0);
    Double_t par[4];
    TF1 *g0    = new TF1("g0","gaus",740,768);
    ...
    h1->Fit(total,"R");
    c1->SaveAs("Americio-100VconFit.pdf",".pdf");
    c1->SaveAs("Americio-100VconFit.root",".root");
}
