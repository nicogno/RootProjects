{
    ...
    double xmax, xmin;
    TCanvas *c1 = new TCanvas("c1","ADC CH7", 1600, 1600);
    
    in.open("ADCsingoleCH7.dat");
    ...
    h3->DrawCopy("","");
    c1->cd(4);          //////////////////////
    TH1 *frame = c1->DrawFrame(0,0,1200,4900,"Pedestal + Signal;ADC Channels;Counts");
    c1->Update();
    h3->Draw("SAME");
    h2->Draw("SAME");
    c1->SaveAs("ADC CH7.pdf","pdf");
}
