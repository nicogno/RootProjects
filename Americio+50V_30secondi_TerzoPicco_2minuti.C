{
    ...
    TH1D *h1 = new TH1D("Histogram and Fit parameters","Americio+50V_30secondi_TerzoPicco_2minuti",1024,0,1023);
    // TH1D *h2 = new TH1D("Histogram parameters","Spettro Cobalto (scintillatore A);# CH;Counts",1024,0,1023);
    
    in.open("Americio+50V_30secondi_TerzoPicco_2minuti.mca");
    ...
    h1->SetMinimum(0);
    Double_t par[4];
    TF1 *g0    = new TF1("g0","gaus",430,760);
    ...
    h1->Fit(total,"R");
    c1->SaveAs("Americio+50V_30secondi_TerzoPicco_2minuticonFit.pdf",".pdf");
    c1->SaveAs("Americio+50V_30secondi_TerzoPicco_2minuticonFit.root",".root");
}
