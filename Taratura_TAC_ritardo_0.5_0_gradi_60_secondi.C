{
    ...
    TCanvas *c1 = new TCanvas("c1","Taratura_TAC_ritardo_0.5_0_gradi_60_secondi", 1600, 1200);
    TH1D *h1 = new TH1D("Histogram and Fit parameters","Coincidenze Sodio per taratura TAC (0 gradi, 60 secondi, ritardo 0.5);# CH;Counts",1024,0,1023);
    
    in.open("Taratura_TAC_ritardo_0.5_0_gradi_60_secondi.mca");
    ...
    TF1 *g0    = new TF1("g0","gaus",520,580);
    TF1 *g1    = new TF1("g1","gaus",580,610);
    ...
    h1->Fit(total,"R");
    c1->SaveAs("Taratura_TAC_ritardo_0.5_0_gradi_60_secondi.pdf",".pdf");
    c1->SaveAs("Taratura_TAC_ritardo_0.5_0_gradi_60_secondi.root",".root");
}
