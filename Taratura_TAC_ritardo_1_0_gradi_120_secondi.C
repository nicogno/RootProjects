{
    ...
    TCanvas *c1 = new TCanvas("c1","Taratura_TAC_ritardo_1_0_gradi_120_secondi", 1600, 1200);
    TH1D *h1 = new TH1D("Histogram and Fit parameters","Coincidenze Sodio per taratura TAC (0 gradi, 120 secondi, ritardo 1);# CH;Counts",1024,0,1023);
